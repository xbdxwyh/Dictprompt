...
if __name__ == '__main__':
    ...
    model = RobertaForSequenceClassification.from_pretrained(args.model).cuda()
    ...
    with open('ALL_RESULTS\\SM_'+args.model+'_7_12.txt','a+') as f:
        f.writelines([str(i)+'\n' for i in [max_acc]])
    # save best model
    with open('ALL_RESULTS\\SM_'+args.model+'_7_12.txt', 'r') as f:
        data = f.readlines()
